...
class neuralNetwork:
    ...
    def __init__(self, inputnodes, hiddennodes, outputnodes, learningrate):
        ...
        self.weight_input_hidden = (numpy.random.rand(self.hidden_nodes, self.input_nodes) - 0.5)#w1
    ...
    def train(self, inputs_list, targets_list):
        ...
        hidden_inputs = numpy.dot(self.weight_input_hidden, inputs) #z1
        #outputs from hidden layer
        hidden_outputs = self.activation_function(hidden_inputs) #a1
        
        #inputs to output layer
        final_inputs = numpy.dot(self.weight_hidden_output, hidden_outputs) #z2
        #outputs from output layer
        final_outputs = self.activation_function(final_inputs) #a2
...
for record in test_list:
    ...
    print("label=",label," ",correct_label)
